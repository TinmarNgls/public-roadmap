...
const mockChangelogData: ChangelogEntry[] = [
  {
    ...
    type: 'feature',
    items: [
      'Added multi-language support for French and Portuguese',
      'Improved mobile responsiveness across all screens',
      'New upvoting system with email notifications',
  ...
  },
  {
    ...
    type: 'bugfix',
    items: [
      'Fixed issue with comment submission',
      'Improved loading times for project cards',
      'Fixed responsive layout issues on tablets',
      'Resolved translation loading errors'
    ]
  },
  {
    id: '3',
    ...
    items: [
      ...
      'New kanban board layout for project status',
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-gray-100 mb-2">Changelog</h2>
              ...
              <div className="ml-16 bg-[#383b3e] rounded-lg p-6 border border-gray-700 w-full">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-gray-700 text-xs text-gray-300">
